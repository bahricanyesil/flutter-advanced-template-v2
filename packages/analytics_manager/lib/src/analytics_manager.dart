...
abstract class AnalyticsManager {
  ...
  ///
  /// This method should be implemented to perform any necessary setup for
  /// the analytics manager.
  Future<void> init();

  /// Dispose the analytics manager.
  ///
  /// This method should be implemented to clean up any resources used by
  /// the analytics manager.
  void dispose();
  ...
  ///
  /// This method logs a screen view event with the provided name and
  /// parameters.
  ...
  ///
  /// This method logs a user login event with the provided login method and
  /// parameters.
  Future<void> onLogIn({
  ...
  ///
  /// This method logs a user sign up event with the provided sign up method
  /// and parameters.
  ...
  ///
  /// This method logs a share event with the provided content type, item ID,
